#!/usr/bin/env python3
"""
Ising Model Tree - Test Input File Generator

This file contains a simple test generator for testing scale-up.
...
Usage Examples:
    ...
    ./gentest.py -n <output file> -s <number of spins> -w <width, e.g. 4>
